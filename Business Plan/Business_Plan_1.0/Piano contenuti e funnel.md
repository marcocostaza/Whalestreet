# Piano contenuti e funnel

No.: 6
Status: Done

Come fai awareness e come converti in clienti.
...
- Mandiamo una serie di e-mail che hanno un percorso prestabilito che finisce con un’offerta di vendita.
- Webinar di formazione con il quale accedere ad un’offerta riservata.

Vendita, dove avviene l’ultimo contatto.

- Per chi ha lasciato solo la mail, inviamo un’offerta.
- Per chi ha lasciato anche il numero di telefono, proponiamo di chiamarlo.

---

Extra: Funnel Partner. L'utente atterra su una Landing Page dedicata (senza distrazioni, incentrata sull'offerta). La promessa è: "Ottieni 1 mese di Whale Academy gratis".

Questo può essere comodo a noi singoli (o come società) nel caso in cui abbiamo collaborazioni con altre aziende e brand e vogliamo sfruttare le CPA.

Caso specifico con XTB già in corso:

- Azione richiesta: L'utente deve aprire un conto sul broker partner (es. XTB) usando il link di affiliazione di Marco, depositare il capitale minimo di 400€ e fare una prima operazione su FX/IND/CMD.
- Risultato: L'utente invia la prova di deposito tramite l’apposito form, noi sblocchiamo 1 mese di accesso 100% gratuito all'Academy. Terminato il mese, l'utente potrà decidere se rinnovare pagando l'abbonamento standard.